...
"x86_64-linux-5.4.0-42-generic" or
	die "Errno architecture (x86_64-linux-5.4.0-42-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
